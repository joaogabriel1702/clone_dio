...
const Card = () => {
    ...
    <CardContainer>
        ...
        <Content>
            <UserInfo>
                <UserPicture src='https://avatars.githubusercontent.com/u/38577266?v=4'/>
                <div>
                    <h4>João Gabriel</h4>
                    <p>Há 8 minutos</p>
                </div>
            ...
            <PostInfo>
                ...
                <p>Projeto feito para o curso de html e css no bootcamp da DIO do Global do inter <strong>Saiba mais</strong></p>
            </PostInfo>
            <HasInfo>
